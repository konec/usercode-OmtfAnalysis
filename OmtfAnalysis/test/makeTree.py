...
process.MessageLogger.debugModules.append('esProd')
...
# from KArol's simOmtfDigis_extrapolSimple_cfi:
...
process.omtfEmulator.stubEtaEncoding = cms.string("bits")
...
process.omtfEmulator.useStubQualInExtr = cms.bool(False)
